...
const ITEMS = [
  ...
  { id: 4, src: "/images/herramientas-lit.jpg", title: "Detalles del laboratorio", description: "Cada herramienta tiene un propósito: precisión absoluta en cada milímetro.", category: "Laboratorio" },
