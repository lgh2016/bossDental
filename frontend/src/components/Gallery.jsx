...
const ITEMS = [
  ...
  { id: 3, src: "/imagenes/sala-revision.jpg", title: "Sala de revisión", description: "Cada espacio está pensado para que tu visita sea rápida y placentera.", category: "Laboratorio" },
